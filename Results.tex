...
\vspace{-.2cm}
\centering
\includegraphics[width=.9\textwidth]{figure/results2.pdf}
\vspace{-.3cm}
\caption{Illustration of results and findings\pat{it would be nice to use the same fonts of the papers}}
\label{fig:results}
\vspace{-.2cm}
\end{figure*}
...
\noindent {\bf F5.1: Project members have sufficient information.} Both companies, \company{} and the supplier, state that they have sufficient information available from both companies to perform their activities:
...
RQ4 (i.e. {\em Are industry-wide standards and processes shared among organizations an enabler?}) focuses on this aspect: %ese aspects:
...
AUTOSAR, which defines a standard software architecture for electronic control units (ECU) \cite{fennel2006achievements}, is one example. 
...
This is typically done by a Tier-1 supplier, which can cause delays in continuous integration.
...
\ins{This holds both for open source tools and open source standards and frameworks, such as Genivi.} 
However, open-source projects should be mature enough and the management of the project should be clearly \chg{controlled by a person, team, or organization}{defined}.
