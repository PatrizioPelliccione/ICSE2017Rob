...
\emph{Proposition 3:} \chg{Inter-organisational sharing of information is considered simple between members of the projects}{Typical risks of inter-organisational transparency (e.g. distance, tooling, IP) can be managed in practice.} 
...
\noindent {\bf F2.3: \chg{Create an understanding}{Some information is sensitive}.}
...
The interview results {\bf \chg{support}{partly reject} the proposition}: information overload \ins{is a risk} \chg{is unlikely to be considered a problem}{ that can be mitigated through precise information}. This answer to proposition 6 is deduced from \ins{F5.2} and the following finding \ins{F6.1}:
