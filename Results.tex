...
\begin{aquote}{Software architect of Volvo Cars}
...
\begin{aquote}{...}
Open source is a very strong area related to CI [...]. ...the tools are open source and the automotive industry is trying to keep this an open-source as possible. There are some week areas, like code coverage tools. They are very week, unfortunately, so we have to use commercial tools for that.
\end{aquote}
