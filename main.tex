...
The pressure of reducing \del{the} time to market and %\del{improving} \ins
{increasing} flexibility while keeping quality are leading motivations for these companies to embrace \ugh{system-wide} Continuous Integration and Delivery\ins{ (CI\&D), which in the scope of complex automotive value-chains, implies inter-organizational CI\&D}.

In this paper, we investigate the challenges and impediments %\del{system-wide}
{posed by} \ugh{inter-organizational} \del{Continuous {Integration and} Delivery (}CI\&D\del{)} %\del{in the automotive ecosystem} 
...
In particular, we focus on {\em contracts} that regulate the agreements between these companies 
...
\keywords{continuous integration and delivery; transparency; contracts; information sharing; automotive; interview survey}
