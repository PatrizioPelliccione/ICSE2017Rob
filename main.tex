...
\author{\IEEEauthorblockN{Rob van der Valk\IEEEauthorrefmark{1}, Patrizio Pelliccione\IEEEauthorrefmark{2}, Patricia Lago\IEEEauthorrefmark{1}, Rogardt Heldal\IEEEauthorrefmark{2}\IEEEauthorrefmark{3}, and Eric Knauss\IEEEauthorrefmark{2}}
...
\IEEEauthorblockA{\IEEEauthorrefmark{3}{Bergen University College}}
%\IEEEauthorblockA{
%Email: name@xyz.com}
}
...
In this paper we investigate the challenges and impediments of system-wide Continuous Delivery in the automotive ecosystem, i.e. continuous software development that involves agile interaction between an OEM and its software suppliers. 
