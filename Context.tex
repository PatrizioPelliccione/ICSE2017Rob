...
The main objectives of the projects are to investigate (i) the transition of Volvo Cars towards continuous integration and deployment, (ii) new business models and innovative ways of working within the automotive \chg{ecosystem}{value-chain}, and (iii) vehicles as part of system of systems. 
...
In this paper we mostly focus on point (ii) \chg{even though there will be some impact on point~(i)}{and its impact on (i)}. Since OEMs are becoming software companies, nowadays the automotive domain is increasingly attracting the attention of the software engineering community.  
