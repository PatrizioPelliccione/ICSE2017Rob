...
It is a large and complex project with over 100 engineers, and it will be closer to 200 developers and engineers if one count all types. There are close to 30 different SCRUM and Agile teams. It is classified\todo{By whom? What does this mean?} as the highest degree of complexity that can be done between the companies. In an attempt to reduce the complexity, developers from both companies work in the same office space.
