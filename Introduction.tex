...
to embrace system-wide Continuous Integration in order to improve
...
what are the challenges and impediments of system-wide Continuous Integration and Continuous Delivery in the automotive ecosystem. 
...
\begin{itemize}
\item {\em RQ1} - Inter-organisational transparency is not a necessary condition for inter-organizational Continuous Integration/Delivery (CI/D). However, transparency is considered positive for various reasons. %and creates positive synergy effects in terms of efficiency, trust, and mutual understanding while avoiding useless stressful situations. Transparency is also considered positive in terms of increasing the overall the project quality. 
